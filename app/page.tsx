...
export default function Page() {
  ...
  async function payItemSeparately(table:RestaurantTable,orderId:number,item:OrderItem){if(profile?.role!=='waiter'&&profile?.role!=='admin')return; if(item.paid)return;setTableDetail(null);setItemPayment({table,item,orderId});setPaymentMethod('card');setCashReceived('');setMixedCash('');setMixedCard('')}
