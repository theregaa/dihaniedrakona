...
-- 13. СТОЛЫ
-- ============================================================
insert into public.restaurant_tables(name,is_vip) values
('Стол 1',false),('Стол 2',false),('Стол 3',false),('Стол 4',false),
('Стол 5',false),('Стол 6',false),('Стол 7',false),('Стол 8',false),
('Стол 9',false),('Стол 10',false),('Стол 13',false),
('11 | Красная',true),('12 | Черная',true),('14 | Подиум',true);
